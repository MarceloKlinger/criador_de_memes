...
export default class criador_de_memes extends Component {
    ...
    return (
      <View style={styles.body}>
          ...
          <View style={styles.area}>
              ...
              <Image style={styles.guri} source={require('./images/app.jpg')} />
...
AppRegistry.registerComponent('criador_de_memes', () => criador_de_memes);
